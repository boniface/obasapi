...
class DocumentServiceTest extends FunSuite {
  ...
  val entity = Document("879542", "DT4587", "Affidavity proof address ", "url", "mime", LocalDateTime.of(2001, 3, 5, 23, 23, 2), "yes", "")
  ...
  test("readEntity"){
    val result = Await.result(service.roach.getEntity(entity.documentId), 2 minutes)
