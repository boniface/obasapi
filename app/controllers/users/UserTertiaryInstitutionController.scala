...
class UserTertiaryInstitutionController @Inject()
(cc: ControllerComponents, api: ApiResponse) extends AbstractController(cc) with Logging {

  type DomainObject = UserTertiaryInstitution
  def className: String = "UserTertiaryInstitutionController"
  override val logger: Logger = Logger(className)
  def domainService: UserTertiaryInstitutionService = UserTertiaryInstitutionService.apply
